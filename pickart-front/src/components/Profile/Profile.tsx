...
export default function Profile({ Id }: { Id: number }) {
    ...
    if (!profile) {
        ...
        return (
            <>
                <Backgrounde Title={profile.Name} Logo={AvatarPath+profile.Avatar} Description={profile.Information_about_yourself ? profile.Information_about_yourself : "Profile"}></Backgrounde>
